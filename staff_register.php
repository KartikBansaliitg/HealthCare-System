...
require_once 'connect.php';
		$name = $dob = $gender=$age = $number = $email=  $experience = $working = $password = $type="";
    ...
    {  
      echo "reached";
		...
		$dbname = "health";
		  ...
		  $sql = "INSERT INTO $myDB.staff (`name`,`dob`,`gender`,`age`,`email`,`contact_no`,`availability`,`type`,`experience`,`pass_wrd`) VALUES ('$name', '$dob','$gender', '$age', '$email', '$number', '$type','$experience','$password',)";
