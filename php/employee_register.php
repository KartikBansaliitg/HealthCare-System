...
require_once 'connect.php';
    ...
    if(isset($_POST['name']) && isset($_POST['dob']) && isset($_POST['gender']) && isset($_POST['age']) && isset($_POST['number']) && isset($_POST['email']) && isset($_POST['address']) && isset($_POST['experience']) && isset($_POST['working']) && isset($_POST['password']))
    {  
		...
		$dbname = "health";
		  ...
		  $sql = "INSERT INTO $myDB.employee (`name`,`dob`,`gender`,`age`,`email`,`contact_no`,`availability`,`experience`,`type`,`pass_wrd`) VALUES ('$name', '$dob','$gender', '$age', '$email', '$number', '$working','$experience','type','$password')";
              ...
              <div class="bg-white px-4 py-5 sm:p-6">
                <div class="grid grid-cols-6 gap-6">
                 ...
                 <div class="col-span-6 sm:col-span-3">
                  ...
                  <div class="col-span-6 sm:col-span-3">
                    <label for="working" class="block text-sm font-medium text-gray-700">Type</label>
                    <select id="working" name="working"
                      class="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                      <option>Select an option</option>
