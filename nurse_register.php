...
require_once 'connect.php';
		$name = $dob = $gender=$age = $number = $email= $address = $experience = $working = $password = $qualification="";
    ...
    {  
		...
		$dbname = "health";
		  ...
		  $sql = "INSERT INTO $myDB.nurse (`name`,`dob`,`gender`,`age`,`email`,`contact_no`,`availability`,`experience`,`specialisation`,`pass_wrd`) VALUES ('$name', '$dob','$gender', '$age', '$email', '$number', '$working','$experience','$qualification','$password')";
